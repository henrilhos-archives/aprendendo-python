...
# 37. Uma Cia de pulverização utiliza avião para pulverizar lavouras.
...
# Em adição, qualquer fazendeiro cujo custo for maior do que R$ 750,00 tem um desconto de 10%
# sobre o valor que ultrapassar os R$ 750,00. Caso ambos os descontos se aplicam o da área é calculado antes.
#
