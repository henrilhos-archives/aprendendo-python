...
# permitida na via e da distância entre eles.
#
# Assim, ao abrir o semáforo, um veículo começa a acelerar até atingir a
# velocidade permitida, que mantém até chegar ao próximo semáforo, levando um
