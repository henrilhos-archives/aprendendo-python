...
# 20. Uma loja vende seus produtos no sistema entrada mais duas prestações,
# sendo a entrada maior do que ou igual às duas prestações, as quais devem ser
# iguais, inteiras e as maiores possíveis.

# Por exemplo, se o valor da mercadoria for R$270,00, a entrada e as duas
...
# programa que receba o valor da mercadoria e forneça o valor da entrada e das
